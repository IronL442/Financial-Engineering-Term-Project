...
Does relaxing the constant volatility assumption of B&S via Neural SDE outperform both the traditional B&S model and a black-box ANN using the same input variables?
